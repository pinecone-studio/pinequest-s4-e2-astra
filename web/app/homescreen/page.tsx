...
// const APPS = [
//   { id: 1, name: "Photos", icon: "/photos.webp" },
//   { id: 2, name: "Settings", icon: "/setting.webp" },
//   { id: 3, name: "Camera", icon: "/camera.webp" },
//   { id: 4, name: "Clock", icon: "/clock.jpg" },
//   { id: 5, name: "App Store", icon: "/appstore.png" },
//   { id: 6, name: "Face Time", icon: "/facetime.png" },
//   { id: 7, name: "Video", icon: "/" },
//   { id: 8, name: "MonTrip", icon: "/" },
// ];
...
//                 <div
//                   key={app.id}
//                   className="flex flex-col items-center gap-1 cursor-pointer group active:scale-95 transition"
//                 >
//                   <img
//                     src={app.icon}
//                     alt={app.name}
//                     className="w-15 h-15 rounded-xl object-cover shadow-md group-hover:opacity-90"
//                   />
