  ...
  return (
    <div className="flex flex-col items-center gap-1 cursor-pointer group active:scale-95 transition-transform duration-100">
      <img
        src={icon}
        alt={name}
        className={`h-[60px] w-[60px] rounded-xl object-cover shadow-md group-hover:opacity-90 ${
          name === "Settings" ? "scale-[1.16]" : ""
        }`}
      />
...
function DockCalendarIcon() {
  return (
    <div className="flex h-[60px] w-[60px] flex-col items-center justify-center overflow-hidden rounded-xl bg-white shadow-md">
      <div className="pt-1 text-[12px] font-black leading-none tracking-wide text-[#ff3b30]">
        FRI
      </div>
      <div className="text-[38px] font-light leading-[0.95] tracking-[-0.08em] text-black">
        3
      </div>
    </div>
  );
                ...
                >
                  {app.name === "Calendar" ? (
                    ...
                    <img
                      src={app.icon}
                      alt={app.name}
                      className={`h-[60px] w-[60px] rounded-xl object-cover shadow-md ${
                        app.name === "Phone" ? "scale-[1.08]" : ""
                      }`}
                    />
                  )}
                </div>
